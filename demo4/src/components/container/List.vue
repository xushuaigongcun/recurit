  ...
  <div>
    <el-table
      ...
      <el-table-column
        prop="gender"
        label="性别" width="180" :formatter="genderConvert">
      </el-table-column>
      <el-table-column
        prop="identified"
        label="身份证号"
      ...
      <el-table-column
        ...
        label="informationId" width="180">
      </el-table-column>
      <el-table-column
        prop="informationEntity.flag"
        label="是否公司员工" width="180" :formatter="flagConvert">
      </el-table-column>
       <el-table-column
      fixed="right"
      label="操作"
...
<el-dialog title="修改信息" :visible.sync="dialogFormVisible" width="800px" >
  ...
  <el-form-item label="录入者" prop="ruleForm.informationEntity.entryPeople">
    <el-input v-model="ruleForm.informationEntity.entryPeople"  ></el-input>
  </el-form-item>
   </el-row>
   <el-row>
  <el-form-item label="招聘者" prop="recuritPeople">
    <el-input v-model="ruleForm.informationEntity.recuritPeople"></el-input>
  </el-form-item>
 <el-form-item label="毕业时间" prop="graduationTime">
  ...
  <el-form-item label="拥有技能" prop="ruleForm.skills1">
    <el-checkbox-group v-model="ruleForm.skills1" >
      <el-checkbox-button :label="skill.className" v-for="skill in ruleForm.skills1" :key="skill.classId" :value="skill.className"></el-checkbox-button>
    </el-checkbox-group>
  </el-form-item>
 <el-row>
 </el-row>
  ...
  <script>
    ...
    salary(){
      ...
      this.$axios.get('/talentPool/checkIdentified?identified='+identified)
        ...
        load(){
        this.$axios.get('/talentPool/look')
        .then(successResponse=>{
